...
Transaction.MAX_MONEY = 84000000 * 1e8; // Pitcoin has 84M coins
...
Transaction.FEE_PER_KB = 100000; // Pitcoin default fees is 0.001 PTX
...
Transaction.prototype.checkedSerialize = function(opts) {
  ...
  if (serializationError) {
    serializationError.message += ' - For more information please see: ' +
      'http://pitcore.io/guide/transaction.html#serialization-checks';
 ...
 * and a slightly fancier format recognized by pitcore:
 *
 * ```
 * {
 ...
 * }
 * ```
 * Where `address` can be either a string or a pitcore Address object. The
 * same is true for `script`, which can be a string or a pitcore Script.
 *
